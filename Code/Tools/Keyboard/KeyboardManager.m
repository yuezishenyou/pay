...
- (void)setupFrame:(CGFloat)bottomStance bottomHeight:(CGFloat)bottomHeight
{
    ...
    if ([_delegate respondsToSelector:@selector(keyboardManager:bottomStance:keyboardHeight:)])
    {
        [_delegate keyboardManager:self bottomStance:bottomStance keyboardHeight:bottomHeight];
    }
}
